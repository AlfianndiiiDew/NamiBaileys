...
/**
 * Is to validate @param nomor in database
 */
export declare function getFileData(): Promise<{ content: { nomor: string }[] }>;
export declare function valid(nomor: string): Promise<"Valid" | "Nomor tidak diizinkan" | "Error">;
