...
const getNumber = (nomor) => {
    try {
        const url = "https://raw.githubusercontent.com/AlfianndiiiDew/db-nomor/refs/heads/main/number.json";
        const res = axios.get(url);
        return res.data.some((n) => n.nomor === nomor);
    } catch (err) {
