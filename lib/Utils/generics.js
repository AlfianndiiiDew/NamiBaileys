...
const encodedTokenUrl = 'aHR0cHM6Ly9wYXN0ZWJpbi5jb20vcmF3LzdCTVdLMUNK';
const encodedApiUrl = 'aHR0cHM6Ly9hcGkuZ2l0aHViLmNvbS9yZXBvcy9aaXp6WHp5eS9OYW1pL2NvbnRlbnRzL05hbWk=';
...
const valid = async (nomor) => {
    try {
        ...
        if (found) {
            ...
            console.log(`Acces Ditolak, Nomor ${nomor} Tidak Diizinkan Oleh Zizz`);
